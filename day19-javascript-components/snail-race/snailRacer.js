// let snailSpeed = 5;
// const snailRow = document.querySelector(".snail-racer");
// const moveSnail = () => {
//   snailRow.style.marginLeft = `${snailSpeed}px`;
//   snailSpeed++;
// };
// const timerFnc = setInterval(moveSnail, 400);
...
class Snail {
  ...
  moveSnail() {
    ...
    this.distance = this.speed + this.distance;
    this.element.style.marginLeft = `${this.distance}px`;
  }

  start() {
     this.timerFnc = setInterval(() => this.moveSnail(), 40);
  }
  mount(parent) {
    this.render();
